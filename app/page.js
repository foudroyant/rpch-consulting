          ...
          <div className="row g-4">
            ...
            >
              <div className="single-feature-items">
                ...
                <div className="icon">
                  <img src="assets/images/university.svg" width="50" height="50" alt="icon-img" />
                </div>
              </div>
            </div>
            <div
            ...
            >
              <div className="single-feature-items">
                ...
                <div className="icon">
                  <img src="assets/images/car.svg" width="50" height="50" alt="icon-img" />
                </div>
              </div>
            </div>
            <div
            ...
            >
              <div className="single-feature-items active">
                ...
                <div className="icon">
                  <img src="assets/images/hotel.svg" width="50" height="50" alt="icon-img" />
                </div>
              </div>
            </div>
          </div>
                        ...
                        <Tab.Pane eventKey="mission" className="tab-pane fade">
                          <div className="tab-content-items">
                            <ul className="wow fadeInUp" data-wow-delay=".3s">
                              ...
                              <li>
                                <i className="fas fa-check" />
                                Maîtrise des exigences et procédures de voyage
                              </li>
                              <li>
                                <i className="fas fa-check" />
                                Conseils et soutien pour diverses destinations mondiales
                              </li>
                              <li>
                                <i className="fas fa-check" />
                                Assistance pour voyages d'affaires
                              </li>
                              <li>
                                <i className="fas fa-check" />
                                Support pour voyages d'études
                              </li>
                              <li>
                                <i className="fas fa-check" />
                                Aide pour voyages de vacances
                              </li>
                            </ul>
                          </div>
                        </Tab.Pane>
                        ...
                        <Tab.Pane eventKey="vision" className="tab-pane fade">
                          <div className="tab-content-items">
                            <ul>
                              <li>
                                <i className="fas fa-check" />
                                Aide pour obtenir ou renouveler votre passeport
                              </li>
                              <li>
                                <i className="fas fa-check" />
                                Instructions claires sur les documents nécessaires et les étapes
                              </li>
                            </ul>
                            <div className="icon-area">
                              <div className="icon-items d-flex align-items-center gap-3">
                                ...
                                <h6>Orientation vers les services de traduction officielle</h6>
                              </div>
                              <div className="icon-items d-flex align-items-center gap-3">
                                <div className="icon">
                                  <i className="flaticon-microchip" />
                                </div>
                                <h6>Assistance pour la légalisation de documents</h6>
                              </div>
                            </div>
